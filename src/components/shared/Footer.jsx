      ...
      <div className="wrapper ">
        <div className="grid grid-cols-1 md:grid-cols-4">
          <div>
            <div>
              ...
              <h1 className="text-2xl font-bold">NextStartup</h1>
          ...
          <nav className="md:justify-self-end mt-8 md:mt-0">
            <ul className="flex flex-col gap-2">
              ...
              <li className="font-thin">
                <a
                  href="https://www.startupbangladesh.vc/"
                  target="_blank"
                  rel="noreferrer"
                >
                  Startup Bangladesh
              ...
              <li className="font-thin">
                <a href="https://idea.gov.bd/" target="_blank" rel="noreferrer">
                  Idea Project
                </a>
              </li>
              ...
              <NavLink to="/">
                <li className="font-thin">
                  <a href="https://ictd.gov.bd/">ICTD</a>
                </li>
              </NavLink>
              <NavLink to="/">
                <li className="font-thin">
                  <a href="http://ims.ictd.gov.bd/">ICT Innovation</a>
                </li>
              </NavLink>
            </ul>
          </nav>
        ...
        <div className="flex text-right text-sm text-gray-400  justify-end">
          <div className="flex flex-col items-end space-y-4  justify-end">
            ...
            <div>
              <p>&copy; {new Date().getFullYear()} by NextStartup</p>
